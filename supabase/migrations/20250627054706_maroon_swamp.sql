-- CloudCollect Database Schema for Cloudflare D1
...
-- 2. Debtors Table (Main Account Data)
...
CREATE UNIQUE INDEX IF NOT EXISTS idx_debtors_company_account ON debtors(company_id, account_number);
